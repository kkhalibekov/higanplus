...
class SelfAttention(nn.Module):
    ...
    def forward(self, x, x_len=None, **kwargs):
        ...
        energy = torch.bmm(
            proj_query.transpose(1, 2), proj_key
        )  # transpose check
...
class GBlock(nn.Module):
    def __init__(
        ...
        in_channels,
        out_channels,
        which_conv1=nn.Conv2d,
        which_conv2=nn.Conv2d,
        which_bn=bn,
        activation=None,
        upsample=None,
    ):
        ...
        self.which_conv1, self.which_conv2, self.which_bn = (
            which_conv1,
            which_conv2,
            which_bn,
        )
...
class DBlock(nn.Module):
    ...
    def forward(self, x, **kwargs):
        if self.preactivation:
            # h = self.activation(x)
            # This line *must* be an out-of-place ReLU or it
